#!/bin/bash
# OllamaTrad Launcher Script for macOS
# Version: 3.0
# Extension .command permet le double-clic sur macOS
...
check_python() {
    ...
    echo ""
    echo "1. Installer Homebrew (si pas déjà fait):"
    echo "   /bin/bash -c \"\$(curl -fsSL https://raw.githubusercontent.com/Homebrew/install/HEAD/install.sh)\""
    echo ""
    echo "2. Installer Python:"
    echo "   brew install python-tk@3.12"
    echo ""
    echo "OU télécharger depuis: https://www.python.org/downloads/macos/"
    return 1
}
