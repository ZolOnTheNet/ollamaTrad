# -*- coding: utf-8 -*-
"""
Formulaire de traduction avec champs multi-lignes pour OllamaTrad.

Fonctionnalités:
- Text widgets multilignes avec hauteur auto-ajustable
- Boutons de validation et rollback par langue
- Baguette magique pour amélioration IA
- Support DeepL pour traduction professionnelle
